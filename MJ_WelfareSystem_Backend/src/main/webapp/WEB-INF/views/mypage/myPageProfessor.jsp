					...
					<div class="rightBox">
						...
						<section id="memberInfo">
							...
							<div id="myPageProfessor" style="display: block;">
                                ...
                                <spring:url value="/myPageProfessor.do" var="myPageProfessorAction" />
                                <form action="${myPageProfessorAction}" name="ProfessorPage" method="POST" id="form">
							...
							<div id="btnDiv">
                                ...
                                </a> <spring:url value="/modifyPassword" var="modifyPasswordUrl" /> <a href="${modifyPasswordUrl}"
									onClick="window.open(this.href, '', 'width=800, height=800'); return false;">
